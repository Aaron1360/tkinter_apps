...
from tkinter import Button, Entry, Menu, ttk
...
class Menu(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        # create the widgets
        menu_buton1 = ttk.Button(self, text = "Button 1")
        menu_buton2 = ttk.Button(self, text = "Button 2")
        menu_buton3 = ttk.Button(self, text = "Button 3")
        ...
        # place the widgets
        menu_buton1.grid(row=0,column=0,sticky="nswe",columnspan=2)
        menu_buton2.grid(row=0,column=2,sticky="nswe")
        menu_buton3.grid(row=1,column=0,columnspan=3,sticky="nswe")
        ...
        # entry layout
        entry.place(relx=0.5,rely=0.90,relwidth=0.9,anchor="center")
